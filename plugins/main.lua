...
-- ImmediateModManager compatibility
if sScrapper == -1.0 then
    sScrapper       = gm.sprite_add(_ENV["!plugins_mod_folder_path"].."/plugins/Sprites/sScrapper.png", 1, false, false, 10, 25)
    sScrapWhite     = gm.sprite_add(_ENV["!plugins_mod_folder_path"].."/plugins/Sprites/sScrapWhite.png", 1, false, false, 13, 13)
    sScrapGreen     = gm.sprite_add(_ENV["!plugins_mod_folder_path"].."/plugins/Sprites/sScrapGreen.png", 1, false, false, 13, 13)
    sScrapRed       = gm.sprite_add(_ENV["!plugins_mod_folder_path"].."/plugins/Sprites/sScrapRed.png", 1, false, false, 13, 13)
    sScrapYellow    = gm.sprite_add(_ENV["!plugins_mod_folder_path"].."/plugins/Sprites/sScrapYellow.png", 1, false, false, 13, 13)
end
